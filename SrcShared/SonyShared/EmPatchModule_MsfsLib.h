...
#ifndef	_EMPATCHMODULE_MSFSLIB_H
#define _EMPATCHMODULE_MSFSLIB_H
// ======================================================================
...
class EmPatchModule_MsfsLib : public EmPatchModule
{
	public:
								EmPatchModule_MsfsLib	(void);
		virtual					~EmPatchModule_MsfsLib (void){}
};
...
#endif	// _EMPATCHMODULE_MSFSLIB_H
