// EmRegsSzNaples.cpp: EmRegsSzNaples クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
#define hwrSZNaplesPortNMS_INS			0x10		// PN4: MS_INS メモリスティック挿入検出割り込み(IRQ3)
#define hwrSZNaplesPortNAlermLED		0x20		// PN5: ATNLED_ON AlermLED
#define	hwrSZNaplesPortNVibrate			0x80		// PN7: VIBRATE 振動モーター

// Port P Bit settings for Naples
#define	hwrSZNaplesPortPDC_IN			0x80		// PP7 : DC_IN / DCｼﾞｬｯｸ電源供給あり
