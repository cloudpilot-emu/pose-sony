...
#include "SonyShared\SessionFileSony.h"
		...
		Bool					ReadHwrDBallSZType		(HwrM68SZ328Type&);
...
#if INCLUDE_SECRET_STUFF
		Bool					ReadDBallSZState		(Chunk& chunk) { return fFile.ReadChunk (kDBEZState, chunk); }
#endif	// INCLUDE_SECRET_STUFF
...
#if INCLUDE_SECRET_STUFF
		void					WriteHwrDBallSZType		(const HwrM68SZ328Type&);
#endif	// INCLUDE_SECRET_STUFF
...
#if INCLUDE_SECRET_STUFF
		void					WriteDBallSZState		(const Chunk& chunk) { fFile.WriteChunk (kDBEZState, chunk); }
#endif	// INCLUDE_SECRET_STUFF
...
#if INCLUDE_SECRET_STUFF
			kDBSZRegsChunk1		= 'DBS1',	// Memory-mapped registers struct. Chunk 1.
			kDBSZRegsChunk2		= 'DBS2',	// Memory-mapped registers struct. Chunk 2.
#endif	// INCLUDE_SECRET_STUFF
...
#if INCLUDE_SECRET_STUFF
			kDBSZState			= 'SSt8',	// Extra state stored outside of the memory-mapped registers struct.
#endif	// INCLUDE_SECRET_STUFF
